...
extension MarkerInfoWindowViewController: GMSMapViewDelegate {
    func mapView(_: GMSMapView, markerInfoWindow marker: GMSMarker) -> UIView? {
    ...
    func mapView(_: GMSMapView, didCloseInfoWindowOf marker: GMSMarker) {
        showToast(message: "Info window for marker \(marker.title ?? "") closed.")
    }

    func mapView(_: GMSMapView, didLongPressInfoWindowOf marker: GMSMarker) {
