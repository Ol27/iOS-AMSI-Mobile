...
extension PanoramaViewController: GMSPanoramaViewDelegate {
    func panoramaView(_: GMSPanoramaView, didMove camera: GMSPanoramaCamera) {
        print("Camera:\(camera.orientation.heading), \(camera.orientation.pitch), \(camera.zoom)")
    }

    func panoramaView(_: GMSPanoramaView, didMoveTo _: GMSPanorama?) {
    ...
    func panoramaViewDidStartRendering(_: GMSPanoramaView) {
        statusLabel.alpha = 0.8
        statusLabel.text = "Rendering"
    }

    func panoramaViewDidFinishRendering(_: GMSPanoramaView) {
        statusLabel.alpha = 0
    }
}
